...
--
-- Servidor: localhost
-- Tiempo de generación: 22-10-2015 a las 20:47:36
...
--
ALTER TABLE `caja`
 ADD PRIMARY KEY (`idCaja`,`TipoCaja_idTipoCaja`), ADD KEY `fk_Caja_TipoCaja1_idx` (`TipoCaja_idTipoCaja`), ADD KEY `physic` (`physic`);
...
--
ALTER TABLE `darsena`
 ADD PRIMARY KEY (`idDarsena`,`DarsenaEstado_idDarsenaEstado`), ADD KEY `fk_Darsena_DarsenaEstado1_idx` (`DarsenaEstado_idDarsenaEstado`);
...
--
ALTER TABLE `estante`
 ADD PRIMARY KEY (`idEstante`,`EstanteEstado_idEstanteEstado`), ADD KEY `fk_Estante_EstanteEstado1_idx` (`EstanteEstado_idEstanteEstado`);
...
ALTER TABLE `estante_has_caja`
 ADD PRIMARY KEY (`Estante_idEstante`,`Estante_EstanteEstado_idEstanteEstado`,`Caja_idCaja`,`Caja_TipoCaja_idTipoCaja`), ADD KEY `fk_Estante_has_Caja_Caja1_idx` (`Caja_idCaja`,`Caja_TipoCaja_idTipoCaja`), ADD KEY `fk_Estante_has_Caja_Estante1_idx` (`Estante_idEstante`,`Estante_EstanteEstado_idEstanteEstado`);

--
-- Indices de la tabla `factura`
--
ALTER TABLE `factura`
 ADD PRIMARY KEY (`idFactura`,`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`,`Cliente_idCliente`), ADD KEY `fk_Factura_RRHH1_idx` (`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_Factura_Cliente1_idx` (`Cliente_idCliente`), ADD KEY `fk_Factura_tiporrhh1` (`tiporrhh_idTipoRRHH`);
...
ALTER TABLE `func_tiporrhh`
 ADD PRIMARY KEY (`idFunc`), ADD KEY `tiporrhh_idTipoRRHH` (`tiporrhh_idTipoRRHH`);

--
-- Indices de la tabla `hojaruta`
--
ALTER TABLE `hojaruta`
 ADD PRIMARY KEY (`idHojaRuta`,`Transporte_idTransporte`,`Transporte_TIpoTransporte_idTIpoTransporte`,`Transporte_RRHH_idRRHH`,`Transporte_tiporrhh_idTipoRRHH`), ADD KEY `fk_HojaRuta_Transporte1_idx` (`Transporte_idTransporte`,`Transporte_TIpoTransporte_idTIpoTransporte`,`Transporte_RRHH_idRRHH`,`Transporte_tiporrhh_idTipoRRHH`);
...
ALTER TABLE `pallet_has_caja`
 ADD PRIMARY KEY (`Pallet_idPallet`,`Caja_idCaja`,`Caja_TipoCaja_idTipoCaja`), ADD KEY `fk_Pallet_has_Caja_Pallet1_idx` (`Pallet_idPallet`), ADD KEY `fk_Pallet_has_Caja_Caja1_idx` (`Caja_idCaja`,`Caja_TipoCaja_idTipoCaja`);

--
-- Indices de la tabla `pedido`
--
ALTER TABLE `pedido`
 ADD PRIMARY KEY (`idPedido`,`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`,`Cliente_idCliente`), ADD KEY `fk_Pedido_RRHH1_idx` (`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_Pedido_Cliente1_idx` (`Cliente_idCliente`), ADD KEY `fk_Pedido_tiporrhh1` (`tiporrhh_idTipoRRHH`);
...
ALTER TABLE `stagearea`
 ADD PRIMARY KEY (`idStageArea`,`TipoStageArea_idTipoStageArea`), ADD KEY `fk_StageArea_TipoStageArea_idx` (`TipoStageArea_idTipoStageArea`);

--
-- Indices de la tabla `stagearea_has_pallet`
--
ALTER TABLE `stagearea_has_pallet`
 ADD PRIMARY KEY (`StageArea_idStageArea`,`StageArea_TipoStageArea_idTipoStageArea`,`Pallet_idPallet`), ADD KEY `fk_StageArea_has_Pallet_StageArea1_idx` (`StageArea_idStageArea`,`StageArea_TipoStageArea_idTipoStageArea`), ADD KEY `fk_StageArea_has_Pallet_Pallet1_idx` (`Pallet_idPallet`);

--
-- Indices de la tabla `stockcenter`
--
ALTER TABLE `stockcenter`
 ADD PRIMARY KEY (`idStockCenter`,`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_StockCenter_RRHH1_idx` (`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_StockCenter_tiporrhh1` (`tiporrhh_idTipoRRHH`);

--
-- Indices de la tabla `stockcenter_has_caja`
--
ALTER TABLE `stockcenter_has_caja`
 ADD PRIMARY KEY (`StockCenter_idStockCenter`,`Caja_idCaja`,`Caja_TipoCaja_idTipoCaja`), ADD KEY `fk_StockCenter_has_Caja_StockCenter1_idx` (`StockCenter_idStockCenter`), ADD KEY `fk_StockCenter_has_Caja_Caja1_idx` (`Caja_idCaja`,`Caja_TipoCaja_idTipoCaja`);

--
-- Indices de la tabla `stockcenter_has_darsena`
--
ALTER TABLE `stockcenter_has_darsena`
 ADD PRIMARY KEY (`StockCenter_idStockCenter`,`Darsena_idDarsena`,`Darsena_DarsenaEstado_idDarsenaEstado`), ADD KEY `fk_StockCenter_has_Darsena_StockCenter1_idx` (`StockCenter_idStockCenter`), ADD KEY `fk_StockCenter_has_Darsena_Darsena1_idx` (`Darsena_idDarsena`,`Darsena_DarsenaEstado_idDarsenaEstado`);

--
-- Indices de la tabla `stockcenter_has_estante`
--
ALTER TABLE `stockcenter_has_estante`
 ADD PRIMARY KEY (`StockCenter_idStockCenter`,`Estante_idEstante`,`Estante_EstanteEstado_idEstanteEstado`), ADD KEY `fk_StockCenter_has_Estante_StockCenter1_idx` (`StockCenter_idStockCenter`), ADD KEY `fk_StockCenter_has_Estante_Estante1_idx` (`Estante_idEstante`,`Estante_EstanteEstado_idEstanteEstado`);

--
-- Indices de la tabla `stockcenter_has_stagearea`
--
ALTER TABLE `stockcenter_has_stagearea`
 ADD PRIMARY KEY (`StockCenter_idStockCenter`,`StageArea_idStageArea`,`StageArea_TipoStageArea_idTipoStageArea`), ADD KEY `fk_StockCenter_has_StageArea_StockCenter1_idx` (`StockCenter_idStockCenter`), ADD KEY `fk_StockCenter_has_StageArea_StageArea1_idx` (`StageArea_idStageArea`,`StageArea_TipoStageArea_idTipoStageArea`);

--
-- Indices de la tabla `ticket`
--
ALTER TABLE `ticket`
 ADD PRIMARY KEY (`idTicket`,`MotivoTicket_idMotivoTicket`,`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`,`Transporte_idTransporte`,`Transporte_TIpoTransporte_idTIpoTransporte`,`Transporte_RRHH_idRRHH`,`Transporte_tiporrhh_idTipoRRHH`), ADD KEY `fk_Ticket_MotivoTicket1_idx` (`MotivoTicket_idMotivoTicket`), ADD KEY `fk_Ticket_RRHH1_idx` (`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_Ticket_Transporte1_idx` (`Transporte_idTransporte`,`Transporte_TIpoTransporte_idTIpoTransporte`,`Transporte_RRHH_idRRHH`,`Transporte_tiporrhh_idTipoRRHH`), ADD KEY `fk_Ticket_tiporrhh1` (`tiporrhh_idTipoRRHH`);
...
ALTER TABLE `transporte`
 ADD PRIMARY KEY (`idTransporte`,`TIpoTransporte_idTIpoTransporte`,`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_Transporte_TIpoTransporte1_idx` (`TIpoTransporte_idTIpoTransporte`), ADD KEY `fk_Transporte_RRHH1_idx` (`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_Transporte_tiporrhh1` (`tiporrhh_idTipoRRHH`);

--
-- Indices de la tabla `transporte_has_caja`
--
ALTER TABLE `transporte_has_caja`
 ADD PRIMARY KEY (`Transporte_idTransporte`,`Transporte_TIpoTransporte_idTIpoTransporte`,`Transporte_RRHH_idRRHH`,`Transporte_tiporrhh_idTipoRRHH`,`Caja_idCaja`,`Caja_TipoCaja_idTipoCaja`), ADD KEY `fk_Transporte_has_Caja_Transporte1_idx` (`Transporte_idTransporte`,`Transporte_TIpoTransporte_idTIpoTransporte`,`Transporte_RRHH_idRRHH`,`Transporte_tiporrhh_idTipoRRHH`), ADD KEY `fk_Transporte_has_Caja_Caja1_idx` (`Caja_idCaja`,`Caja_TipoCaja_idTipoCaja`);

--
-- Indices de la tabla `transporte_has_pallet`
--
ALTER TABLE `transporte_has_pallet`
 ADD PRIMARY KEY (`Transporte_idTransporte`,`Transporte_TIpoTransporte_idTIpoTransporte`,`Transporte_RRHH_idRRHH`,`Transporte_tiporrhh_idTipoRRHH`,`Pallet_idPallet`), ADD KEY `fk_Transporte_has_Pallet_Transporte1_idx` (`Transporte_idTransporte`,`Transporte_TIpoTransporte_idTIpoTransporte`,`Transporte_RRHH_idRRHH`,`Transporte_tiporrhh_idTipoRRHH`), ADD KEY `fk_Transporte_has_Pallet_Pallet1_idx` (`Pallet_idPallet`);

--
-- Indices de la tabla `user`
--
ALTER TABLE `user`
 ADD PRIMARY KEY (`idAutenticacion`,`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_Autenticacion_RRHH1_idx` (`RRHH_idRRHH`,`tiporrhh_idTipoRRHH`), ADD KEY `fk_Autenticacion_TipoRRHH1` (`tiporrhh_idTipoRRHH`);
...
--
ALTER TABLE `tipocaja`
MODIFY `idTipoCaja` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
