    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          ...
          <p class = "text-muted">Control de Acceso al Sistema según el Tipo de Usuario ,
              abarcando los procesos completamente desde inicio a fin.
          </p>
          </aside>
            </section>
        </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          ...
          <p class = "text-muted">Tenga el dominio de su stock al alcance de las ultimas tecnologias ,recibiendo notificaciones de 
          transacciones online.</p>
          </aside>
            </section>
        </div>
      </div>
            ...
            <!--div class="col-sm-push-5 col-md-2 sidebar">
                    
                            
                            <p>
				<a class="btn btn-lg btn-primary btn-group-justified "
