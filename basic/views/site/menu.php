...
<body>  
    <!--div class="container">
        ...
        <div class="dropdown">
            <button class="btn btn-success dropdown-toggle" type="button"  id="Menu" data-toggle="dropdown" aria-extended="true">
                Menu
                <span class="caret"></span>
            </button>
            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownmenu1">
                <li><a href="http://localhost/logistica/web/index.php?r=usuarios/index"> Usuario</a></li>   
